...
public class GamingPageSteps {
	...
	/**
	 * This method asserts whether the desired page is displayed. 
	 * Added sleep to to the method to slow the driver for demonstration purposes.
	 * @throws InterruptedException when sleep fails
	 */
	@Then("^the website displays gaming laptops$")
	public void the_website_displays_gaming_laptops() throws InterruptedException  {
	...
	public void filter_options_are_present(DataTable filterOptions) throws Throwable {
